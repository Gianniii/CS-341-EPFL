...
public:
    ...
    **/
    bool  intersect(const Ray& _ray, Object_ptr&, vec3& _point, vec3& _normal, double& _t, vec3& tex);
    ...
    */
    vec3  lighting(const vec3& _point, const vec3& _normal, const vec3& _view, const Material& _material, vec3& tex);
